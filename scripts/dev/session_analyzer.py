...
Usage:
    python3 scripts/session_analyzer.py --repo my-repo
    python3 scripts/session_analyzer.py --repo my-repo --date 2026-03-06
    python3 scripts/session_analyzer.py --repo my-repo --json
...
def main():
    ...
    group.add_argument("--repo", help="Repo name prefix (e.g. my-repo)")
