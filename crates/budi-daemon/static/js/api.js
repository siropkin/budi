...
async function loadStatsData(signal) {
  ...
  const [summary, sessionsResult, cwds, cost, models, activityChart, providers, contextUsage, topTools, branches, tickets] = await Promise.all([
  ...
  statsData = { summary, sessions, cwds, cost, models, activityChart, contextUsage, topTools, branches, tickets };
